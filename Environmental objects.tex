...
\usepackage{siunitx}
\usepackage{breqn}
\usepackage[backend=biber, backref=true, style=apa, uniquename=false, sortcites=false]{biblatex} 
...
\title{Procedural underwater terrain generation with Environmental Objects}

% for anonymous conference submission please enter your SUBMISSION ID
% instead of the author's name (and leave the affiliation blank) !!
% for final version: please provide your *own* ORCID in the brackets following \orcid; see https://orcid.org/ for more details.
\author[paper1524]{paper1524}
%\author
...
% 
% 
    % Simulating underwater landscape growth is complex due to the interplay of biological, environmental, physical, geological, and human factors. Accurate modeling requires integrating species interactions, environmental variables, dynamic physical processes, and long-term geological changes. Additionally, climate change and human impacts add unpredictability. This multifaceted challenge demands interdisciplinary approaches and advanced computational resources to effectively capture the gradual and intricate nature of underwater ecosystem development.
    % In this paper we introduce the use of environmental objects, a sparse representation of geological and biological elements of the scene affecting their local environment, to 
	% In this paper we present a novel method to generate underwater landscapes adaptable for large and small scale terrains by using a incremental generation. The creation and evolution of elements of the terrain is managed by the use of environmental objects, a sparse representation of geological and biological elements of the scene affecting their local environment. 
	%-------------------------------------------------------------------------
...
\ccsdesc[100]{Computing methodologies~Description logics}
...
\begin{align} \label{eq:material-displacement-equation}
